    ...
    for (int row = 0; row < 9; ++row) {
        for (int col = 0; col < 9; ++col) {
            ...
            if(col == 2 || col == 5 || col == 8){
                button->setStyleSheet("color: black; background-color: white; border: 1px solid black; border-right: 2px solid black");
            }
            else if(col == 0){
                button->setStyleSheet("color: black; background-color: white; border: 1px solid black; border-left: 2px solid black");
            }
            else{
            ...
            if(row == 0){
                button->setStyleSheet("color: black; background-color: white; border: 1px solid black; border-top: 2px solid black");
            }
            else if(row == 2 || row == 5 || row == 8){
                button->setStyleSheet("color: black; background-color: white; border: 1px solid black; border-bottom: 2px solid black");
            }
            else{
                button->setStyleSheet("color: black; background-color: white; border: 1px solid black;");
            }
