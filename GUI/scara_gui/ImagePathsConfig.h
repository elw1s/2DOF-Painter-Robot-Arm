#ifndef IMAGEPATHSCONFIG_H
#define IMAGEPATHSCONFIG_H

#include <string>

//Upload Image
extern const std::string CROP_ICON;
extern const std::string DRAG_DROP_ICON;
extern const std::string ROTATE_ICON;
extern const std::string SELECT_FILE_ICON;
//Draw Image
